var store = [{
        ...
        "title": "Splash Page",
        "excerpt":"Nullam suscipit et nam, tellus velit pellentesque at malesuada, enim eaque. Quis nulla, netus tempor in diam gravida tincidunt, proin faucibus voluptate felis id sollicitudin. Centered with type=\"center\" Placeholder 1 This is some sample content that goes here with Markdown formatting. Image courtesy of Unsplash Placeholder 2 This is some...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/splash-page/",
        "teaser": null
      },{
        ...
        "excerpt":"I took Knowledge-Based Artifical Intelligence Fall 2019 and throughly enjoyed the class projects and the ability to frontload all the course content as this class overlapped with our five week trip through Oceania. In addition to many ethics essays, the class grade was mostly based on a cummulative project using...","categories": [],
        "tags": ["Projects","OMSCS","AI","Computer Vision"],
        "url": "http://localhost:4000/kbai/",
